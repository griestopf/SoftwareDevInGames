...
int main() {
    ...
    // 
    // TODO: As a first iteration, implement a simple reference counting mechanism (mimicking
    // Godot's Ref<T> behavior as closely as possible, including copy semantics and automatic cleanup when no longer referenced.
